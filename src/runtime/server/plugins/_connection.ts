...
export function getNatsConnection() { return _nc }
export function getJetStream() { return _js }
export function getJetStreamManager() { return _jsm }

export function setNatsConnection(nc: NatsConnection | undefined) { _nc = nc }
export function setJetStream(js: JetStreamClient | undefined) { _js = js }
export function setJetStreamManager(jsm: JetStreamManager | undefined) { _jsm = jsm }
